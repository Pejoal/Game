import { mergeProps, withCtx, createVNode, openBlock, createBlock, unref, Fragment, renderList, toDisplayString, useSSRContext } from "vue";
          ...
          if (_push2) {
            ...
            ssrRenderList(_ctx.$page.props.locales, (locale, code) => {
              _push2(`<button type="button" class="${ssrRenderClass([
                code === unref(active_locale_code) ? "bg-zinc-900 text-white" : "text-gray-900 hover:text-white",
